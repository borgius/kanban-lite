 ...
 */
export declare function resolveTemplateString(template: string, ctx: CardInterpolationContext): string;
/**
 ...
 * // => { nested: { owner: 'bob' } }
 */
export declare function prepareFormData(value: Record<string, unknown>, ctx: CardInterpolationContext): Record<string, unknown>;
/**
 ...
 */
export declare function buildCardInterpolationContext(card: {
    id: string;
    status: string;
    priority: string;
    assignee: string | null;
    ...
    formData?: Record<string, unknown>;
    metadata?: Record<string, unknown>;
}, boardId: string): CardInterpolationContext;
