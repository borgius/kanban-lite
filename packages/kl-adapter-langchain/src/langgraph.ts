 ...
 * import { KanbanBoardState, createRefreshBoardNode, createKanbanToolNode } from 'kl-adapter-langchain'
 *
...
function createKanbanBoardState() {
  ...
  if (!Annotation) {
    throw new Error(
      'kl-adapter-langchain: @langchain/langgraph is required for KanbanBoardState. ' +
