...
```bash
npm install kl-chat-sdk-adapter ai zod
```
...
import { createKanbanTools } from 'kl-chat-sdk-adapter'
...
```ts
import { KanbanClient } from 'kl-chat-sdk-adapter'
...
pnpm --filter kl-chat-sdk-adapter build
pnpm --filter kl-chat-sdk-adapter test
