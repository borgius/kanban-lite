...
```python
from kl_crewai_tools import KanbanLiteClient, MoveCardTool, ListCardsTool
...
If the kanban-lite server has auth enabled (via `kl-auth-plugin`):
