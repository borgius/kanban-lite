...
function buildSpec(): OpenAPISpec {
  try {
    ...
    return buildStandaloneOpenApiSpec(
      collectStandalonePluginOpenApiDocs(capabilityBag.standaloneHttpPlugins as readonly StandaloneHttpPlugin[], {
        workspaceRoot: ROOT,
    ...
    return buildStandaloneOpenApiSpec() as OpenAPISpec
  }
}
